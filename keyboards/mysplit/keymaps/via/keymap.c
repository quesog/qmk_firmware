...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_default(
    ...
    KC_PGDN,   ____  KC_LCTL, KC_LGUI, KC_LALT, MO(2), MO(1), KC_SPC,             KC_SPC, ____     ____  KC_RALT, KC_RGUI, KC_MENU, KC_RCTL     ____
  ),

  [1] = LAYOUT_default(
    KC_TRNS, KC_TRNS, KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,   KC_F6,     KC_F7,   KC_F8,    KC_F9,    KC_F10,    KC_F11,   KC_F12,  KC_TRNS,   ____
